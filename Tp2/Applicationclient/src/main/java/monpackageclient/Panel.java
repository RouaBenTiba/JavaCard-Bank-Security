...
public class Panel extends JFrame implements ActionListener{
	...
	public Panel(Maclasse client, Apdu apdu) {
        this.client = client;
        this.apdu = apdu;
     ...
     jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\pc\\Downloads\\javacard\\project1-20241212T144310Z-001\\project1\\src\\main\\java\\com\\mycompany\\project1\\interface2.png")); // NOI18N
    ...
    private void jButton2ActionPerformed(ActionEvent evt) {
    	Money direction = new Money(client, apdu);
